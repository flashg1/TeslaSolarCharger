...
-   Allow topup from grid if there is not enough solar electricity.  Need to turn on charge from grid toggle and specify day time/night time power offsets for charging or export to grid.
